...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">FRESH GREENS</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="blog.html" class="nav-link">Recipes</a></li>
	          <li class="nav-item"><a href="contact.html" class="nav-link">Nutritional advice</a></li>
    ...
    <div class="" style="background-image: url('images/');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"> <span></span></p>
  ...
  <form action="" method="post" class="form">
    ...
    <br>
    <textarea name="message" cols="30" rows="10" class="form__textarea" placeholder="Message"></textarea>
    <br>
    <button type="submit" class="form__button" name="post_comment">Post Comment</button>
  </form>
</div>
